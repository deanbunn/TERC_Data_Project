...
SELECT TmStamp,
	   ...
	   WaveHeight,
	   Conductivity25C_Avg
FROM [CR1000 - NS Homewood Modem_LakeData]
...
BEGIN
	...
	SELECT @D_SQL = 'CALL sp_insert_cr1000_ns_homewood_modem_lakedata(''' + CONVERT(nvarchar, @cr_TmStamp, 120) + ''',' 
	...
	INSERT INTO ExportDean(spcalltext)
	VALUES(@D_SQL);
