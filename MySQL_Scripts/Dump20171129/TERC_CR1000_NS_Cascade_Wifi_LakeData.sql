...
--
-- Table structure for table `CR1000_NS_Cascade_Wifi_LakeData`
--

DROP TABLE IF EXISTS `CR1000_NS_Cascade_Wifi_LakeData`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `CR1000_NS_Cascade_Wifi_LakeData` (
  ...
  PRIMARY KEY (`ld_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3125295 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2017-11-29 12:45:39
