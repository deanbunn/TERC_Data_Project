...
--
-- Table structure for table `CR1000_NS_Dollar_Point_Modem_LakeData`
--

DROP TABLE IF EXISTS `CR1000_NS_Dollar_Point_Modem_LakeData`;
...
CREATE TABLE `CR1000_NS_Dollar_Point_Modem_LakeData` (
  ...
  PRIMARY KEY (`ld_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2816051 DEFAULT CHARSET=latin1;
