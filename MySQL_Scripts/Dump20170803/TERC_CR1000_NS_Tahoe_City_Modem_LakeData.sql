...
--
-- Table structure for table `CR1000_NS_Tahoe_City_Modem_LakeData`
--

DROP TABLE IF EXISTS `CR1000_NS_Tahoe_City_Modem_LakeData`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `CR1000_NS_Tahoe_City_Modem_LakeData` (
  ...
  PRIMARY KEY (`ld_id`)
) ENGINE=InnoDB AUTO_INCREMENT=299127 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2017-08-03 12:09:19
