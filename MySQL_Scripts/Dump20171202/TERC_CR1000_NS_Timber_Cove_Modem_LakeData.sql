...
--
-- Table structure for table `CR1000_NS_Timber_Cove_Modem_LakeData`
--

DROP TABLE IF EXISTS `CR1000_NS_Timber_Cove_Modem_LakeData`;
...
CREATE TABLE `CR1000_NS_Timber_Cove_Modem_LakeData` (
  ...
  PRIMARY KEY (`ld_id`)
) ENGINE=InnoDB AUTO_INCREMENT=68797 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2017-12-02 13:25:42
