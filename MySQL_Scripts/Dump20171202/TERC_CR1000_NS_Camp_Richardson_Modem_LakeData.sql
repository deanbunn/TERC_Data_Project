...
--
-- Table structure for table `CR1000_NS_Camp_Richardson_Modem_LakeData`
--

DROP TABLE IF EXISTS `CR1000_NS_Camp_Richardson_Modem_LakeData`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `CR1000_NS_Camp_Richardson_Modem_LakeData` (
  ...
  `LS_DO_Conc_Avg` double DEFAULT NULL,
  `LS_DO_ProbeTemp_Avg` double DEFAULT NULL,
  PRIMARY KEY (`ld_id`)
) ENGINE=InnoDB AUTO_INCREMENT=71982 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2017-12-02 13:25:48
